...
{
    public abstract class ExpressionVisitorExt
    {
        protected ExpressionVisitorExt() { }
    ...
    public class PartialEvaluator : ExpressionVisitorExt
    {
        ...
        /// </summary>
        private class Nominator : ExpressionVisitorExt
        {
            private Func<Expression, bool> m_fnCanBeEvaluated;
            private HashSet<Expression> m_candidates;
